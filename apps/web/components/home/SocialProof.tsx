    ...
    <section className="px-5">
      <div className="relative mx-auto max-w-container space-y-7.5 overflow-hidden pt-11">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <Paragraph>
            <strong className="text-neutral-900 dark:text-neutral-100">4.8M+ drivers</strong> prepared ·{" "}
            <strong className="text-neutral-900 dark:text-neutral-100">97%</strong> pass first try
          </Paragraph>
