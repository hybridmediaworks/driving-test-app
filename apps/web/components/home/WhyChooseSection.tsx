      ...
      <div className="mx-auto max-w-container px-5">
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3 lg:mt-[41px]">
          {CARDS.map((card) => (
            <div
              key={card.title}
              className="flex flex-col gap-6 rounded-3xl border border-neutral-200 dark:border-white/10 bg-white dark:bg-neutral-800 p-8 shadow-[0px_20px_40px_-10px_rgba(11,11,13,0.1)] lg:p-12"
            >
              <div className="flex items-center gap-4 lg:gap-6">
                ...
                <h3 className="font-sora text-4xl font-semibold tracking-[-0.96px] text-[#0b0b0d] dark:text-neutral-100 lg:text-5xl lg:leading-[56px]">
                  {card.title}
                </h3>
              </div>
