          ...
          <Heading as="h2">
            ...
            <span className="relative inline-block whitespace-nowrap">
              ...
              <svg
                ...
                fill="none"
                className="pointer-events-none absolute bottom-[-0.14em] left-0 h-[0.2em] w-full"
              >
                <path
        ...
        <div className="mt-12 grid items-center gap-8 lg:grid-cols-[minmax(0,230px)_minmax(0,1fr)_minmax(0,230px)] lg:gap-6">
          ...
          <div className="order-2 flex w-full max-w-sm flex-col gap-6 justify-self-center lg:order-1 lg:max-w-none">
            {STATS.map((stat) => (
              <div
                key={stat.label}
                className="rounded-2xl border-2 border-background3 bg-white p-4 shadow-[0px_1px_1px_rgba(14,17,22,0.06),0px_2px_3px_rgba(14,17,22,0.05)]"
              >
            ...
            {PASSERS.map((p, i) => (
              ...
              >
                ...
                <p className="mt-2 flex items-center gap-2 text-base text-neutral-500">
                  <BadgeCheck className="size-6 shrink-0 text-green-500" />
                  Passed 2 mins ago.
                </p>
              </div>
            ))}
