...
export default function GoFurtherSection() {
  ...
  const resourceCards = [
    {
      icon: Clock,
      title: `60-Second ${selectedState} Motorcycle Permit Plan`,
      description:
    ...
    {
      icon: Volume1,
      title: "Audio Operator Manual",
      description: `Listen to the full ${selectedState} motorcycle operator manual on your commute — 2h 10m, chaptered.`,
      buttonText: "Read the manual",
    },
    {
      icon: Map,
      title: `Find ${selectedState} DMV Offices`,
      description:
        "Locations, hours, and what to bring for your written and skills tests near you.",
    ...
    },
    {
      ...
      description: `Stuck on a rule? Ask in plain English and get an answer cited to the ${selectedState} motorcycle operator manual.`,
