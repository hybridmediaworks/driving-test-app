...
import DrivingTestContent from "@/components/state/motorcycle/DrivingTestContent";
import PermitTestContent from "@/components/state/motorcycle/PermitTestContent";
import { useWebLayout } from "@/lib/web-layout-context";

export default function MotorcycleTestTypeContent() {
  ...
  return selectedTestType === "driving_test" ? (
    <DrivingTestContent />
  ) : (
    <PermitTestContent />
  );
