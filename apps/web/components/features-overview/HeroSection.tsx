    ...
    <section className="py-15 md:space-y-15 lg:py-30 px-5">
      <div className="mx-auto max-w-container space-y-12  flex flex-col xl:flex-row justify-between items-center xl:gap-4 gap-8">
        ...
        <div className="max-w-152 relative flex items-center justify-center me-20 ms-10">
          <div className="zoom-70 md:zoom-100 -rotate-4 absolute z-1 -top-10 bg-white dark:bg-neutral-800 p-4 max-w-41.75 rounded-[20px] shadow-[0_16px_32px_-31.912px_rgba(8,9,12,0.12),0_6px_15px_-17.407px_rgba(8,9,12,0.10)]">
          ...
          />
          <div className="zoom-70 md:zoom-100 -rotate-4 absolute z-1 -bottom-10 -left-14 bg-white dark:bg-neutral-800 p-4 max-w-70 rounded-[20px] shadow-[0_16px_32px_-31.912px_rgba(8,9,12,0.12),0_6px_15px_-17.407px_rgba(8,9,12,0.10)]">
            <Paragraph size="lg" color="dark" className="font-bold">
              Car, CDL and motorcycle
            </Paragraph>
            <Paragraph>the same seven tools, retuned per test.</Paragraph>
          </div>
          <div className="zoom-70 md:zoom-100 -rotate-4 absolute z-1  -right-30 bg-white dark:bg-neutral-800 p-4 max-w-56.5 rounded-[20px] shadow-[0_16px_32px_-31.912px_rgba(8,9,12,0.12),0_6px_15px_-17.407px_rgba(8,9,12,0.10)]">
            <Paragraph size="lg" color="dark" className="font-bold">
              47 states
            </Paragraph>
            <Paragraph>
