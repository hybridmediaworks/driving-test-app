      ...
      <div className="mx-auto max-w-container space-y-12">
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-1 gap-5 lg:grid-cols-3 md:grid-cols-2">
            <div className="md:col-span-2 flex flex-col justify-between gap-6 relative rounded-2xl border bg-blue-1000 p-5 lg:p-7 shadow-[0_1px_2px_0px_rgba(0,0,0,0.05)]">
