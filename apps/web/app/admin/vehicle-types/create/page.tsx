...
export default function CreateVehicleTypePage() {
  ...
  async function submit(e: FormEvent) {
    ...
    try {
      await api.post("/admin/vehicle-types", { name, title, is_active: isActive });
    ...
    <AdminGuard>
      <AppLayout
        breadcrumbs={[
          ...
          { title: "New", href: "/admin/vehicle-types/create" },
        ]}
      >
        <div className="app-page">
          <div className="space-y-0.5">
            <h1 className="text-lg font-semibold">New vehicle type</h1>
          ...
          <form className="w-full max-w-xl space-y-6" onSubmit={submit}>
            <div className="grid gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                Lowercase, e.g. <code>car</code>, <code>motorcycle</code>
              </p>
