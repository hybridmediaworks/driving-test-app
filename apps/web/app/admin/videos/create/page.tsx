    ...
    <AdminGuard>
      <AppLayout
        breadcrumbs={[
          ...
          { title: "New", href: "/admin/videos/create" },
        ]}
      >
        <div className="app-page">
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Leave category/state/vehicle blank for a video that applies universally.
            </p>
          </div>
          ...
          <form className="w-full max-w-2xl space-y-6" onSubmit={submit}>
            ...
            <div className="grid gap-2">
              ...
              <Input
                id="source_url"
                placeholder="https://... (where this video was originally found)"
                value={sourceUrl}
              ...
              {sourceType === "external" ? (
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="path" placeholder="videos/example.mp4" value={path} onChange={(e) => setPath(e.target.value)} />
